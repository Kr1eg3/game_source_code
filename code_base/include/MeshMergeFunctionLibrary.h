...
struct MYPROJECT_API FSkelMeshMergeSectionMapping_BP
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MYPROJECT_API FSkelMeshMergeUVTransform
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MYPROJECT_API FSkelMeshMergeUVTransformMapping
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct MYPROJECT_API FSkeletalMeshMergeParams
{
	GENERATED_BODY()
...
*/
UCLASS()
class MYPROJECT_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	/**
